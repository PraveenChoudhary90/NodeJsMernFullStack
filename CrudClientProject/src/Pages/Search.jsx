 ...
 function Search() {
  ...
  return (
    ...
    <div style={{textAlign:"center"}}>
        ...
        <br></br>
        <hr />
        <h5>Enter the Employee No: <input type="text" name="empno" onChange={(e)=>{SetInput(e.target.value)}} /> 
         ...
         <div className="main" style={{display:"flex" ,justifyContent:"center", alignItems:"center", gap:"10px", flexWrap:"wrap"}}>
         {
            ...
            Alldata.map((e ,index)=>
                ...
                <Card style={{ width: '18rem' }} key={index}>
                        ...
                        <Card.Title>Employee No :{e.empno}</Card.Title>
                        <Card.Text> Employee Designation: {e.designation}
                        </Card.Text>
