...
export default function UpdateFrom() {
  ...
  return (
    ...
    <input type="text" className="form-control" name='name'  value={edit_data.name} onChange={HandleINput}/ >
        ...
        <div className="mb-3">
        <label htmlFor="exampleFormControlInput1" className="form-label">Enter the Employee No:</label>
        <input type="text" className="form-control" name='empno'  value={edit_data.empno}  onChange={HandleINput}/>
        </div>
        <div className="mb-3">
        <label htmlFor="exampleFormControlInput1" className="form-label">Enter the Employee Designation:</label>
        <input type="text" className="form-control"  name='designation' value={edit_data.designation} onChange={HandleINput}/>
        </div>
        <div className="mb-3">
