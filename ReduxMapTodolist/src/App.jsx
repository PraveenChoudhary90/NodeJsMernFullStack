    ...
    return(
      <>
        <tr key={index}>
          <td>{sno}</td>
          <td>{key.work}</td>
          <td onClick={()=>{dispatch(DeleteTask({id:key.id}))}}><Button variant="danger">Delete</Button></td>
          <td onClick={()=>{EditTask(key.id, key.work)}}><Button variant="primary">Update</Button></td>
        </tr>
